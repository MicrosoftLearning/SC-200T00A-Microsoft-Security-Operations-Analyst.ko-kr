...
ms.locfileid: "137899286"
---
# <a name="module-3-create-queries-for-azure-sentinel-using-kusto-query-language-kql"></a>모듈 3 - KQL(Kusto 쿼리 언어)을 사용하여 Azure Sentinel용 쿼리 만들기
