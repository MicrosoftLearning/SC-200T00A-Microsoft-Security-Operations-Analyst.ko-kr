...
1. **힌트:** 이전 연습에서 관리자 권한으로 명령 프롬프트가 열려 있을 수 있습니다. 명령 프롬프트에서 루트 디렉터리에 Temp 폴더를 만듭니다.
...
#### <a name="attack-2---user-add-and-elevate-privilege"></a>마지막 행 후에 Enter 키를 눌러야 합니다.

1. 공격 2 - 사용자 추가 및 권한 상승 이 명령을 복사하고 실행하여 관리자 계정 만들기를 시뮬레이션합니다.
...
## <a name="proceed-to-exercise-7"></a>마지막 행 후에 Enter 키를 눌러야 합니다.
