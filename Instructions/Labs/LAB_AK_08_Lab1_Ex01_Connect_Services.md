...
1. *MOC 구독-XXXXXXXXXXX*의 *상태*는 *연결됨*이어야 하고 *양방향 동기화*는 **사용**으로 설정되어야 합니다.

    >**참고:** *양방향 동기화 사용*을 확인하려면 이 절차를 다시 시도해야 할 수도 있습니다. 단계를 다시 실행한 다음, *양방향 동기화* 드롭다운을 **사용**으로 설정해 보세요.
