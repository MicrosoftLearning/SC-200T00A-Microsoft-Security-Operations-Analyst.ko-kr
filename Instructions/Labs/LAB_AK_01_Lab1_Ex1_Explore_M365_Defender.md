...
1. 표시된 경우 Microsoft 365 Defender 빠른 둘러보기 팝업 창을 닫습니다. **힌트:** 이 랩 후반부에서는 Defender 작업 영역이 프로비전될 때까지 기다려야 합니다. 이 시간 동안 가이드 투어를 탐색하여 Microsoft 365 Defender에 대해 자세히 알아볼 수 있습니다.
...
1. **Microsoft 365 Defender** 포털의 탐색 메뉴 왼쪽에서 **홈**을 선택합니다.
