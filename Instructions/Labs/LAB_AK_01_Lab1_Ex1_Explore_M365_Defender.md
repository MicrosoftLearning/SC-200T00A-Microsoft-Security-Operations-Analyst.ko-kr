...
1. **설정** 페이지에서 **Microsoft 365 Defender**를 선택합니다. 커피 머그잔의 이미지와 다음과 같은 메시지가 표시됩니다. 잠시 기다려 주세요! 데이터에 사용한 새 공간을 준비하고 연결하고 있습니다. 완료하는 데 몇 분 정도 걸리므로 페이지를 열어 두고 다음 랩에 필요하므로 완료를 확인해야 합니다. 
