...
1. Microsoft Sentinel 작업 영역의 *위협 관리* 영역에서 **Notebooks**를 선택합니다.
...
1. **전자 필기장을** 다시 선택한 다음, 가운데 명령 모음에서 **템플릿** 탭을 선택합니다. 
...
1. 명령 모음의 **Compute instance:** 선택기 오른쪽에서 기호를 **+** 선택하여 새 컴퓨팅 instance 만듭니다. **힌트:** 줄임표 아이콘 **(...)** 내부에 숨겨져 있을 수 있습니다.
...
1. 화면 아래쪽에서 **만들기** 단추를 선택합니다. 표시할 수 있는 피드백 창을 닫습니다. 이 작업이 완료되면 알림(벨 아이콘)이 표시되고 *컴퓨팅 instance* 왼쪽 아이콘이 파란색에서 녹색으로 바뀝니다.
...
>**참고:** Notebook에 액세스하기 위해 위의 단계를 완료할 수 없는 경우 대신 GitHub 뷰워 페이지에서 이를 따를 수 있습니다. [Azure ML Notebooks 및 Microsoft Sentinel을 사용하여 시작](https://nbviewer.org/github/Azure/Azure-Sentinel-Notebooks/blob/master/A%20Getting%20Started%20Guide%20For%20Azure%20Sentinel%20ML%20Notebooks.ipynb) 
