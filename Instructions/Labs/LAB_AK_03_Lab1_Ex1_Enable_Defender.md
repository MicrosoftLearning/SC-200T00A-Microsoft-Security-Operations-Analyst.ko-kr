...
1. 자동 프로비전 - 확장을 검토합니다. **Log Analytics 에이전트/Azure Monitor 에이전트**가 **꺼짐**으로 설정되어 있는지 확인합니다.
...
1. **모든 클라우드용 Microsoft Defender 플랜 사용**을 선택하고 **저장**을 선택합니다. “작업 영역 uniquenameDefender에 대한 Microsoft Defender 플랜이 성공적으로 저장되었습니다.” 알림이 표시될 때까지 기다립니다. 기다립니다.
